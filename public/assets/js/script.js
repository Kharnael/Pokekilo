...
fetchApi = async () => {
    for (let index = 1; index <= 10; index++) {
        ...
        <article class="col col-md-6 col-lg-3 d-flex justify-content-center flex-column my-4 ">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="bi  bi-cart-plus-fill my-2 mx-auto cartAdd" data-pokeName="${pokeName}" data-pokeId="${pokeId}" data-pokeImg="${imgPoke}" data-pokePrice="${pokePrice}" viewBox="0 0 16 16">
